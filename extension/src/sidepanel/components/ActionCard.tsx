...
/**
 * Blink-style UI components for Solana Intent Pilot.
 * Focused on high-density information display and smooth animations.
 */
    ...
    >
      {preview ? (
        ...
        <div 
          ...
          style={{ 
            margin: "24px 0", padding: "24px 0", textAlign: "center", color: "#64748b", fontSize: 14, borderRadius: 16,
